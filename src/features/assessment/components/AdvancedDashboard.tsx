...
import { CheckCircle, AlertCircle, ArrowUp, ArrowDown, Info, Building, ScrollText, Shield, FileText, Target, TrendingUp, Clock, PieChart as PieChartIcon, Eye, Zap, Search, Plus, Trash2, Upload, Star, Activity } from 'lucide-react';
...
export const AdvancedDashboard: React.FC<AdvancedDashboardProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 px-8 py-8">
      {/* Breadcrumbs */}
      <div className="mb-6">
            ...
            <div key={risk} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-full transition-all duration-300 group-hover:scale-110 ${
                  risk === 'critical' ? 'bg-red-100 dark:bg-red-900/30' : risk === 'high' ? 'bg-orange-100 dark:bg-orange-900/30' : risk === 'medium' ? 'bg-yellow-100 dark:bg-yellow-900/30' :
              ...
              <div className="mt-4 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className={`h-full rounded-full transition-all duration-500 ${
                    risk === 'critical' ? 'bg-red-500' : risk === 'high' ? 'bg-orange-500' : risk === 'medium' ? 'bg-yellow-500' :
                    'bg-green-500'}`}
