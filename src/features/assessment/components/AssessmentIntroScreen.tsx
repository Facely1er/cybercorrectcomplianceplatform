...
import { ChevronLeft, CheckCircle, AlertCircle, BookOpen, Building, Globe, Lightbulb as ZapLightbulb, Lock, Shield, Users, Zap } from 'lucide-react';
...
export const AssessmentIntroScreen: React.FC<AssessmentIntroScreenProps> = ({ frameworks, onStartAssessment, onBack }) => {
  ...
  const totalQuestions = currentFramework.sections.reduce((sum: number, section: any) =>
    sum + section.categories.reduce((catSum: number, category: any) => catSum + category.questions.length, 0),
  0);
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {getFrameworkBenefits(currentFramework.id).map((benefit: string, index: number) => (
            ...
            {currentFramework.industry && currentFramework.industry.length > 0 && (
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {currentFramework.industry.map((industry: string, index: number) => (
                    <span
                      key={index}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
              <FrameworkIcon className="w-8 h-8 mr-3 text-green-600 dark:text-green-400" />
              Assessment Coverage
            </h2>
            ...
            <div className="space-y-6">
              {currentFramework.sections.map((section: any, index: number) => { const sectionQuestions = section.categories.reduce((sum: number, category: any) => sum + category.questions.length, 0);
                ...
                return (
                  <div key={section.id} className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:shadow-md transition-shadow">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <ZapLightbulb className="w-4 h-4 text-blue-500" />
                        <span className="text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
              <ZapLightbulb className="w-8 h-8 mr-3 text-yellow-500" />
              Preparation Checklist
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {getPreparationChecklist(currentFramework.id).map((item: string, index: number) => (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sticky top-24">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-2">
                {currentFramework?.maturityLevels?.map((level: any, index: number) => (
            ...
            <div className="mt-8 space-y-3">
              ...
              >
                <ZapLightbulb className="w-5 h-5" />
                <span>Start Assessment</span>
              </button>
              
              <button
                onClick={() => onStartAssessment(organizationInfo as OrganizationInfo, selectedFramework)}
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
            <h3 className="text-lg font-semibold text-green-900 dark:text-green-100 mb-4 flex items-center">
              <ZapLightbulb className="w-5 h-5 mr-2" />
              Assessment Tips
            </h3>
