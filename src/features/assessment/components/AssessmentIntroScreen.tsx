                ...
                {frameworks.map((framework) => (
                  <div key={framework.id } className="bg-white dark, bg-gray-700 p-3 rounded-lg">
                    ...
                    <div className="text-blue-600 dark, text-blue-400">
                      {framework.id === 'cmmc' ? '110 controls'  , framework.id === 'privacy' ? '73 questions' , framework.id === 'nist-csf-v2-extended' ? '106 subcategories'  : 'questions'}
                    </div>
            ...
            <div className="grid grid-cols-2 md, grid-cols-4 gap-6 mb-8">
              ...
              <div className="text-center p-4 bg-purple-50 dark, bg-purple-900/20 rounded-xl">
                <div className="text-2xl font-bold text-purple-600 dark, text-purple-400 mb-2">
                  {currentFramework.id === 'cmmc' ? '17'  , currentFramework.id === 'privacy' ? '5' , currentFramework.id === 'nist-csf-v2-extended' ? '6' , currentFramework?.sections?.length || 0}
                </div>
                <div className="text-sm font-medium text-gray-700 dark, text-gray-300">
              ...
              <div className="text-center p-4 bg-orange-50 dark, bg-orange-900/20 rounded-xl">
                <div className="text-2xl font-bold text-orange-600 dark, text-orange-400 mb-2">
                  {currentFramework.id === 'cmmc' ? 'Level 2'  , currentFramework.id === 'privacy' ? 'v1.0' , currentFramework.id === 'nist-csf-v2-extended' ? 'v2.0' : 'v' + (currentFramework?.version || 'N/A')}
                </div>
                <div className="text-sm font-medium text-gray-700 dark, text-gray-300">
          ...
          <div className="bg-white dark: bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark, border-gray-700 p-6 sticky top-24">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-gray-900 dark, text-white">
                  {currentFramework.id === 'cmmc' ? '110'  , currentFramework.id === 'privacy' ? '73' , currentFramework.id === 'nist-csf-v2-extended' ? '106' , totalQuestions || 'N/A'}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-gray-900 dark, text-white capitalize">
                  {currentFramework.id === 'cmmc' ? 'DoD Compliance'  , currentFramework.id === 'nist-csf-v2-extended' ? 'NIST Standard' , currentFramework.id === 'nist-csf-v2-standard' ? 'NIST Lite' , currentFramework.id === 'nist-csf-v2' ? 'NIST Quick Check' , currentFramework.id === 'privacy' ? 'Privacy Regulations' : 'NIST Standard'}
                </span>
              </div>
            </div>
