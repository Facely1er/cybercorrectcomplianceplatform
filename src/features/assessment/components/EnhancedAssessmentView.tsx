...
import { ChevronLeft, ChevronRight, Save, CheckCircle, Lightbulb, AlertTriangle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">The framework data for this assessment could not be loaded properly. Framework ID: {assessment.frameworkId}</p>
          <div className="space-y-3">
            <button onClick={onBack} className="w-full px-4 py-2 bg-primary-teal text-white rounded-lg hover:bg-primary-teal/90 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-teal focus:ring-offset-2">
              Back to Dashboard
            </button>
            <button onClick={() => window.location.reload()} className="w-full px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
              Reload Page
            </button>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">This framework doesn't contain any questions to assess. Framework: {framework.name} (ID, {assessment.frameworkId})</p>
          <button onClick={onBack} className="px-4 py-2 bg-primary-teal text-white rounded-lg hover:bg-primary-teal/90 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-teal focus:ring-offset-2">
            Back to Dashboard
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Assessment Loading Error</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-4">Unable to load assessment questions. Please try again.</p>
          <button onClick={onBack} className="px-4 py-2 bg-primary-teal text-white rounded-lg hover:bg-primary-teal/90 transition-colors">
            Back to Dashboard
          </button>
        </div>
      </div>
