              ...
              <div key={step } className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-gray-700 dark, text-gray-300">
                    Step {step }, { step === 1 ? 'Review and prioritize identified gaps' , step === 2 ? 'Develop remediation plans for high-priority items'  , step === 3 ? 'Allocate resources and assign responsibilities' , step === 4 ? 'Implement security improvements and controls' :
