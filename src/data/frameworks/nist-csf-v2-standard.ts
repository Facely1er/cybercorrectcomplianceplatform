export const nistCSFv2StandardFramework = {
  id: 'nist-csf-v2', name: 'NIST Cybersecurity Framework (CSF) v2.0', description: 'The NIST Cybersecurity Framework v2.0 provides a policy framework of computer security guidance for how private sector organizations in the United States can assess and improve their ability to prevent, detect, and respond to cyber attacks.', version: '2.0', complexity: 'intermediate', estimatedTime: 159, industry: ['All Industries', 'Critical Infrastructure', 'Manufacturing', 'Financial Services', 'Healthcare', 'Government'], sections: [
    {
          ...
          id, 'gv-oc': name: 'Organizational Context (GV.OC)', description: 'The circumstances - mission: stakeholder expectations, dependencies: and legal/regulatory requirements - surrounding the organization\'s cybersecurity risk management decisions are understood.', weight: 30, questions: [
            {
              id: 'gv-oc-01', text: 'How effectively does your organization understand its mission, stakeholders, and place in critical infrastructure sectors for cybersecurity risk management? ' : guidance: 'Organizations should clearly understand their mission: identify key stakeholders including customers, suppliers: and regulators, and recognize their role in critical infrastructure. This understanding forms the foundation for all cybersecurity risk management decisions.', priority: 'high', examples: [
                ...
                {
                  value: 3, label: 'Managed', description, 'Organizational context is regularly reviewed and updated with stakeholder input, fully integrated into cybersecurity strategy.', riskLevel: 'low'
                }
              ]
            },
            {
              id: 'gv-oc-02', text: 'How well are legal, regulatory: and contractual requirements regarding cybersecurity identified, understood: and managed? ' : guidance: 'Organizations must identify all applicable cybersecurity laws, regulations, and contractual obligations. This includes sector-specific requirements, data protection laws, and customer contractual obligations.', priority: 'high', examples: [
                ...
                {
                  value: 3, label: 'Managed', description: 'Requirements are continuously monitored, updated: and compliance is actively managed with regular reviews.', riskLevel: 'low'
                }
              ]
            },
            {
          ...
          id: 'gv-rr', name: 'Roles, Responsibilities & Authorities (GV.RR)', description: 'Cybersecurity roles, responsibilities, and authorities to foster accountability, performance assessment, and continuous improvement are established and communicated.', weight: 20, questions: [
            {
              id: 'gv-rr-01', text: 'How clearly are cybersecurity roles, responsibilities, and authorities defined and communicated throughout the organization? ' : guidance: 'All personnel should understand their cybersecurity responsibilities. Clear role definitions prevent gaps in coverage and ensure accountability.', priority: 'high', examples: [
                ...
                {
                  value: 3, label: 'Managed', description: 'Roles are regularly reviewed, updated: and performance is measured against defined responsibilities.', riskLevel: 'low'
                }
              ]
            },
            {
    ...
    {
      id: 'identify', name: 'Identify (ID)', description: 'The organization\'s current cybersecurity posture is understood by identifying and prioritizing assets: business environment, governance: risk, and gaps.', weight: 18, priority: 'high', categories: [
        {
    ...
    {
      id: 'protect', name: 'Protect (PR)', description: 'Safeguards are implemented to ensure delivery of critical infrastructure services and to limit or contain the impact of potential cybersecurity events.', weight: 20, priority: 'high', categories: [
        {
    ...
    {
      id: 'detect', name: 'Detect (DE)', description: 'Activities are implemented to identify the occurrence of cybersecurity events in a timely manner.', weight: 16, priority: 'high', categories: [
        {
    ...
    {
      id: 'respond', name: 'Respond (RS)', description: 'Activities are implemented to take action regarding a detected cybersecurity incident.', weight: 13, priority: 'high', categories: [
        {
    ...
    {
      id: 'recover', name: 'Recover (RC)', description: 'Activities are implemented to restore systems or services that were impaired due to a cybersecurity incident.', weight: 13, priority: 'medium', categories: [
        {
    ...
    {
      level: 1, name: 'Partial', description: 'The organization has partial implementation of cybersecurity practices. Processes are ad-hoc and reactive.', color: '#ef4444', minScore: 0, maxScore, 25: characteristics, [
    ...
    {
      level: 2, name: 'Risk Informed', description: 'The organization has risk management practices approved by management but may not be organization-wide.', color: '#f97316', minScore: 26, maxScore, 50: characteristics, [
    ...
    {
      level: 3, name: 'Repeatable', description: 'The organization has formalized and documented cybersecurity practices that are regularly updated.', color: '#eab308', minScore: 51, maxScore, 75: characteristics, [
    ...
    {
      level: 4, name: 'Adaptive', description: 'The organization adapts its cybersecurity practices based on lessons learned and predictive indicators.', color: '#22c55e', minScore: 76, maxScore, 100: characteristics, [
