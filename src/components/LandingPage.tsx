...
const TextCarousel: React.FC = () => {
  ...
  const messages = [
    ...
    "Multi-framework harmonization across NIST, CMMC, Privacy, and ISO standards. Reduce compliance complexity with a unified assessment and monitoring platform.",
  ...
  return (
    <div className="relative h-24 md:h-16 flex items-center justify-center">
      <div className="absolute inset-0 flex items-center justify-center">
        <p key={currentIndex} className="text-center animate-slide-up" style={{ animation: 'slideUp 0.5s ease-out' }}>
        ...
        {messages.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${
              index === currentIndex ? 'bg-primary-teal dark:bg-dark-primary' : 'bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500'
            }`}
          />
        ))}
      </div>
  ...
  const compliancePaths = [
    {
      ...
      description:
        'Comprehensive privacy program management built on NIST CSF v2.0 foundations with automated DPIAs, data mapping, and rights management.',
      icon: Eye,
    ...
    },
    {
      ...
      description:
        'Complete CUI protection program leveraging NIST CSF v2.0 controls with data flow mapping, access controls, and compliance documentation.',
      icon: Database,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-teal/5 via-surface to-secondary-teal/10 dark:from-dark-bg dark:via-dark-bg dark:to-dark-primary/10">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-accent-cyan dark:text-accent-cyan">15-240min</div>
      ...
      <div className="py-24 bg-surface dark:bg-dark-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-4">Two Compliance Paths Powered by NIST CSF v2.0</h2>
            <p className="text-xl text-gray-600 dark:text-dark-text/80 max-w-3xl mx-auto">Specialized compliance tracks built on the NIST Cybersecurity Framework v2.0 foundation</p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {compliancePaths.map((path) => (
              <div key={path.id} className="card-enhanced rounded-2xl p-8 group hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-dark-text mb-2 text-center">{path.title}</h3>
                <p className="text-primary-teal dark:text-dark-primary text-center mb-4 font-medium">{path.subtitle}</p>
                <p className="text-gray-600 dark:text-dark-text/80 leading-relaxed mb-6 text-center">{path.description}</p>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs font-medium text-gray-700 dark:text-dark-text">{path.industries.slice(0, 2).join(', ')}</div>
                  </div>
                </div>
                ...
                <div className="bg-primary-teal/5 dark:bg-dark-primary/10 rounded-lg p-3 mb-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-medium text-primary-teal dark:text-dark-primary">{path.framework}</span>
                  </div>
                </div>

                <Link to={path.assessmentPath} className={`bg-gradient-to-r ${path.color} text-white px-6 py-3 rounded-lg hover:opacity-90 transition-all duration-300 font-medium w-full block text-center hover:scale-105`}>
      ...
      <div className="py-24 bg-gradient-to-br from-support-gray/30 to-secondary-teal/10 dark:from-dark-bg dark:to-dark-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-4">Complete Compliance Implementation Suite</h2>
            <p className="text-xl text-gray-600 dark:text-dark-text/80 max-w-3xl mx-auto">Everything you need for NIST CSF v2.0, Privacy, and CUI compliance from assessment to continuous monitoring</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {keyFeatures.map((feature, index) => (
              <div key={index} className="card-enhanced rounded-2xl p-8 group">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-dark-text mb-4">{feature.title}</h3>
                <p className="text-gray-600 dark:text-dark-text/80 leading-relaxed">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-24 bg-surface dark:bg-dark-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-4">NIST CSF v2.0 Core Functions</h2>
            <p className="text-xl text-gray-600 dark:text-dark-text/80 max-w-3xl mx-auto">Six core functions for comprehensive cybersecurity risk management</p>
          </div>
            ...
            {nistFunctions.map((func, index) => (
              <div key={index} className="card-enhanced rounded-xl p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-dark-text">{func.name}</h3>
                </div>
                <p className="text-gray-600 dark:text-dark-text/80 text-sm">{func.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-24 bg-gradient-to-br from-support-gray/30 to-secondary-teal/10 dark:from-dark-bg dark:to-dark-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-4">Solutions Tailored to Your Role</h2>
            <p className="text-xl text-gray-600 dark:text-dark-text/80 max-w-3xl mx-auto">Specialized tools and workflows designed for compliance professionals across different functions</p>
          </div>
              ...
              <div key={persona.id} className="card-enhanced rounded-2xl p-8 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-dark-text mb-2">{persona.title}</h3>

                    <p className="text-gray-600 dark:text-dark-text/80 mb-6">{persona.description}</p>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-3">
                        {persona.painPoints.map((pain, pIndex) => (
                          <div key={pIndex} className="border-l-4 border-primary-teal/30 pl-4">
                    ...
                    <div className="mb-6">
                      ...
                      {persona.features.length > 4 && (
                        <div className="text-base text-gray-500 dark:text-dark-text/60 mt-2">+{persona.features.length - 4} more features</div>
                      )}
                    </div>

                    <Link to={persona.ctaLink} className={`bg-gradient-to-r ${persona.color} text-white px-6 py-3 rounded-lg hover:opacity-90 transition-all duration-300 font-medium w-full block text-center hover:scale-105`}>
                      {persona.primaryCTA}
                    </Link>
                  </div>
                </div>
      ...
      <div className="py-24 bg-surface dark:bg-dark-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-6">Why Choose Our Multi-Framework Platform?</h2>
              ...
              <div className="mt-8">
                <Link to="/help" className="inline-flex items-center space-x-2 text-primary-teal dark:text-dark-primary hover:text-secondary-teal dark:hover:text-accent-cyan font-medium transition-colors duration-300">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary-teal/10 to-secondary-teal/20 dark:from-dark-primary/20 dark:to-dark-primary/30 rounded-2xl p-8 border border-primary-teal/20 dark:border-dark-primary/30 shadow-enhanced">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-primary-teal dark:text-dark-primary mb-4">Multi-Framework Implementation Timeline</h3>

                  <div className="space-y-4 text-left">
                    <div className="flex items-center justify-between">
                      <span className="text-primary-teal/80 dark:text-dark-primary/80">Initial Assessment</span>
                      <span className="text-primary-teal dark:text-dark-primary font-medium">120 minutes</span>
                    </div>
                    <div className="flex items-center justify-between">
      ...
      <div className="py-12 bg-gradient-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Strengthen Your Compliance Posture?</h2>
          <p className="text-xl text-white/80 mb-8">Choose from three comprehensive NIST-based cybersecurity assessments</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">CyberCorrect™</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">by ERMITS</p>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/dashboard" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                    <BarChart3 className="w-4 h-4" />
                    <span>Dashboard</span>
                  </Link>
                </li>
                <li>
                  <Link to="/assessment-intro" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
            ...
            {/* Frameworks */}
            <div>
              <h4 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4">Frameworks</h4>
              <ul className="space-y-3">
                <li>
                  <Link to="/compliance/nist-standard" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                    <Shield className="w-4 h-4" />
                    <span>NIST CSF v2.0 Quick Check</span>
                  </Link>
                </li>
                <li>
                  <Link to="/compliance/cmmc" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                    <Building className="w-4 h-4" />
                    <span>CMMC Level 2</span>
                  </Link>
                </li>
                <li>
                  <Link to="/compliance/privacy" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                    <Eye className="w-4 h-4" />
                    <span>Privacy Compliance</span>
                  </Link>
                </li>
                <li>
                  <Link to="/compliance/nist-extended" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/help" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                    <HelpCircle className="w-4 h-4" />
                    <span>Help & Documentation</span>
                  </Link>
                </li>
                <li>
                  <Link to="/settings" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                    <Settings className="w-4 h-4" />
                    <span>Settings</span>
                  </Link>
                </li>
                <li>
                  <a href="mailto:support@ermits.com" className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center space-x-4 mb-4 md:mb-0">
                <span className="text-sm text-gray-500 dark:text-gray-400">© 2024 ERMITS. All rights reserved.</span>
                <span className="hidden md:block text-gray-300 dark:text-gray-600">•</span>
                <span className="text-sm text-gray-500 dark:text-gray-400">CyberCorrect™ Cybersecurity Compliance Platform</span>
              </div>

              <div className="flex items-center space-x-6">
                <Link to="/privacy-policy" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                  Privacy Policy
                </Link>
                <Link to="/terms" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-teal dark:hover:text-dark-primary transition-colors">
                  Terms of Service
                </Link>
                <span className="text-sm text-gray-500 dark:text-gray-400">v2.0.0</span>
              </div>
            </div>
          </div>
        </div>
