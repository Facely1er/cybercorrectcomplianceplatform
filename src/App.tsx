...
const AssessmentIntroScreen = lazy(() => import('./features/assessment/components/AssessmentIntroScreen'));
const SignInPage = lazy(() => import('./features/auth'));
const AdvancedDashboard = lazy(() => import('./features/assessment/components/AdvancedDashboard'));
const RealTimeComplianceStatus = lazy(() => import('./features/compliance/components/RealTimeComplianceStatus'));
const EvidenceCollectionDashboard = lazy(() => import('./features/evidence/components/EvidenceCollectionDashboard'));
const AdvancedReportingDashboard = lazy(() => import('./features/reporting/components/AdvancedReportingDashboard'));
const AssessmentReportsPage = lazy(() => import('./features/reporting/components/AssessmentReportsPage'));
const TeamTrackingReport = lazy(() => import('./features/reporting/components/TeamTrackingReport'));
const ComplianceCalendarView = lazy(() => import('./features/calendar/components/ComplianceCalendarView'));
const PolicyManagementView = lazy(() => import('./features/policies'));
const ControlsManagementView = lazy(() => import('./features/controls/components/ControlsManagementView'));
const TeamCollaborationDashboard = lazy(() => import('./features/collaboration/components/TeamCollaborationDashboard'));
const TaskManagementDashboard = lazy(() => import('./features/tasks/components/TaskManagementDashboard'));
const AssetDashboard = lazy(() => import('./features/assets/components/AssetDashboard'));
const EnhancedAssessmentView = lazy(() => import('./features/assessment/components/EnhancedAssessmentView'));
const ReportView = lazy(() => import('./features/reporting/components/ReportView'));
const NistStandardCompliancePage = lazy(() => import('./features/compliance'));
const NistExtendedCompliancePage = lazy(() => import('./features/compliance'));
const CmmcCompliancePage = lazy(() => import('./features/compliance'));
const PrivacyCompliancePage = lazy(() => import('./features/compliance'));
const SettingsView = lazy(() => import('./shared/components/ui/SettingsView'));
const HelpView = lazy(() => import('./shared/components/ui/HelpView'));
