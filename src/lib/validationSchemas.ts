...
export const userProfileSchema = z.object({
  ...
  role: z.enum(['viewer', 'user', 'manager', 'admin', 'super_admin']),
...
export const assetSchema = z.object({
  ...
  type: z.enum(['hardware', 'software', 'data', 'personnel', 'facility', 'other']),
  ...
  status: z.enum(['active', 'inactive', 'retired', 'under_review']),
...
export const evidenceSchema = z.object({
  ...
  description: z.string().max(1000, 'Description too long').optional(),
  type: z.enum(['document', 'screenshot', 'log', 'certificate', 'policy', 'procedure', 'other']),
  confidentialityLevel: z.enum(['public', 'internal', 'confidential', 'restricted']),
  linkedQuestions: z.array(z.string()).optional(),
  tags: z.array(z.string().max(50)).max(10).optional(),
...
export const taskSchema = z.object({
  ...
  type: z.enum(['assessment', 'remediation', 'review', 'training', 'audit', 'other']),
